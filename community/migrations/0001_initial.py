    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boardID', models.ForeignKey(db_column='boardID', on_delete=django.db.models.deletion.CASCADE, to='community.board')),
                ('receiveID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receiveID', to='SignUp.user')),
                ('sendID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sendID', to='SignUp.user')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
